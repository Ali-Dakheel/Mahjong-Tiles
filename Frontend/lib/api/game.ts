/**
 * Client-side API functions. These run in the browser and hit the Next.js
 * BFF routes (/api/scores, /api/leaderboard) — never Laravel directly.
 * LARAVEL_URL stays server-side only.
 */
